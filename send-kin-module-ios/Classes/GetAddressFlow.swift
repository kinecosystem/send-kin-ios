...
class GetAddressFlow {
    ...
    func startMoveKinFlow(to destinationApp: App, senderAppId: String, memo: String, completion: @escaping GetAddressFlowCompletion) {
        self.completion = completion

        guard let url = LaunchURLBuilder.requestAddressURL(for: destinationApp, senderAppId: senderAppId, memo: memo) else {
